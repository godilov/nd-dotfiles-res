...
return function(config)
    ...
    local accent    = load_fn('nd.resources.core.color.nvim.accent', accent_cfg, palette)
    local highlight = load_fn('nd.resources.core.color.nvim.highlight', highlight_cfg, palette, accent)
